    ...
    <section id="about" className="about sec-pad">
      <div className="main-container">
        <h2 className="heading heading-sec heading-sec__mb-med">
          ...
          <br/>
          <p className="heading-sec__sub">
            As a further evolution in my technical skill set, I have spent significant time learning computer science, with a strong emphasis on web development. Having already taught myself how to build a basic website from scratch with knowledge of HTML, CSS, and JavaScript, I decided in 2022 to massively upgrade my skills by attending a coding boot camp. Over the winter of 2022-2023, I attended <a href="https://flatironschool.com/" target="_blank">Flatiron School</a>'s Software Engineering Program live in-person on their Denver campus. During this program, my classmates came to know me as someone who is both friendly and knowledgeable, even electing me as <strong>Most Likely to Help Anyone Anytime</strong> with the course material. I facilitated frequent coding walkthroughs, group learning sessions, and provided individual guidance to classmates. This extra engagement provided reinforcement of my own learning, as well as bolstered my ability to communicate software engineering concepts.
          </p>
          <br/>
          <p className="heading-sec__sub">
