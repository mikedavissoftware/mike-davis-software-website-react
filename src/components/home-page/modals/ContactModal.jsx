...
export default function ContactModal() {
  ...
  return (
    <div className="contact" style={{opacity: `${showContactModal ? ("1") : ("0")}`, visibility: `${showContactModal ? ("") : ("hidden")}`}}>

      <div className="contact__form-container-modal" >
      ...
      {/* <div onClick={() => setShowContactModal(false)} style={{display: "fixed", height: "100vh", width: "100vw", zIndex: 1}}></div> */}
