...
export default function HeaderHome() {
  ...
  const resumePath = "./pdf/michael_davis_se_resume_16.pdf"
      ...
      <div className="header__content">
        ...
        <div className="header__main">
          <ul className="header__links animate slide-right">
            ...
            <li className="header__link-wrapper">
              <button className="header__link btn btn--sm btn--theme animate glow delay-3" style={{color: "white", margin: "1.1rem 2rem 1.1rem 1rem", padding: "1.25rem 2rem", letterSpacing: "1px"}} onClick={() => setShowContactModal(!showContactModal)}>Contact</button>
            </li>
            <li className="header__link-wrapper">
              <a href={resumePath} rel="noreferrer noopener" className="header__link btn btn--sm btn--theme animate glow delay-3" style={{color: "white", margin: "1.1rem 0", padding: "1rem 2rem", letterSpacing: "1px"}}>Resume</a>
            </li>
          </ul>
      ...
      <div className={`header__sm-menu${(active) ? ("--active") : ("")}`}>
        <div className="header__sm-menu-content">
          <ul className="header__sm-menu-links">
            ...
            <li className="header__sm-menu-link">
              <button onClick={() => setActive(false)}>Resume</button>
            </li>
          </ul>
        </div>
      </div>
